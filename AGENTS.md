# AGENTS.md — RFC単語帳 AI開発ガイド

AIエージェント（Codex/Claude等）が**「どう作業するか」**を定めたファイル。
...
| `AGENTS.md`（本ファイル） | AIエージェント | 作業手順・コーディング規約・自律改善ループ |
...
├── AGENTS.md               # このファイル（AI向け）
└── CLAUDE.md               # 互換用（AGENTS.mdへの案内）
```
